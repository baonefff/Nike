...
const PopularProducts = () => {
  return (
    <section id="products" className=" max-container max-sm:mt-12">
      ...
      <h2 className="text-4xl font-palanquin font-bold">Our Popular 
      ...
      <div className="mt-16 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1  sm:gap-4 gap-5">
